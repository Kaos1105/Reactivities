...
const ActivityDetailHeader: React.FC<{ activity: IActivity }> = ({ activity }) => {
  ...
  const { cancelAttendance, attendActivity, attendLoading } = rootStore.activityStore;
    ...
    <Segment.Group>
      ...
      <Segment clearing attached='bottom'>
        {activity.isHost ? (
          ...
          <Button loading={attendLoading} onClick={cancelAttendance}>
            Cancel attendance
          </Button>
        ) : (
          <Button loading={attendLoading} onClick={attendActivity} color='teal'>
            Join Activity
          </Button>
        )}
      </Segment>
